...
public class UsuarioRepository {
    ...
    public ResponseEntity<List<ErroresImportador>> cargarExcelUsuarios(InputStream is, String token) {
        ...
        try {
            ...
            // continue;
            // } else {
            // return new ResponseEntity("Introduzca un excel de usuarios válido para
            // importar....",
            ...
            // if (tip == null) {
            // ++importacionesIncorrectas;
            // resultadoImportacion.add(new ErroresImportador("No se importará el
            // registro:",
            ...
            // "Error importando excel de usuarios, al parecer no hay conexión con
            // TRACCAR.....",
            // HttpStatus.BAD_REQUEST);
            // }
            // }
            ...
            // resultadoImportacion.add(new ErroresImportador("No se importará el
            // registro.",
            // "Ya existe un usuario en traccar con el correo electrónico introducido con
            // valor: "
            // + currentCell,
            // importacionesCorrectas, importacionesIncorrectas));
            // break SALTO;
            ...
            // "No se importará el registro.",
            // "El usuario con TIP: " + usuario.getTip()
            // + " se intenta importar en una unidad a la que el usuario importador no tiene
            // permiso.",
            // importacionesCorrectas, importacionesIncorrectas));
            // break SALTO;
            // }
            ...
            // } catch (Exception exception) {
            // log.error("Error encontrando unidad en importadores: " +
            ...
            // "Debe completar los datos de llenado obligatorios del excel marcados con * en
            // el registro.",
            // importacionesCorrectas, importacionesIncorrectas));
            // break SALTO;
            // }
            ...
            // Usuarios usuario_update = usuarioFeignClient.findByTip(usuario.getTip(),
            // token);
